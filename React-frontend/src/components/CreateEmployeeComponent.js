              ...
              <div className="card-body">
                <form>
                  <div className="form-group my-2">
                    ...
                    <input placeholder="First Name" name="firstName" autoComplete='off' className="form-control"  
                           value={employee.firstName} onChange={handleClick}/>
                            
                  </div>
                  <div className="form-group my-2">
                    <label>Last Name:</label>
                    <input placeholder="Last Name" name="lastName" autoComplete='off' className="form-control"
                           value={employee.lastName} onChange={handleClick}/>
                  </div>

                  <div className="form-group my-2">
                    <label>Email:</label>
                    <input placeholder="Email" name="email" autoComplete='off' className="form-control"
